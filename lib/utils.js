...
//分析文档类型
function updateContentType(httpData){
    ...
    var responseData = httpData.responseData;
    if(responseData.length > 0 && type !== null && /^(html|css|js|json|txt|xml)$/.test(type) === true && responseHeaders['content-encoding'] === undefined){
        //检测BOM
